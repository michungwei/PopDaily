...
$content_first_img_url = "http://admin.popdaily.com.tw/".substr($row_news["news_content"], strpos($row_news["news_content"], "upload/"), 39 );
...
<meta name="copyright" content="<?php echo $copyright; ?>" />
	...
	<link rel="stylesheet" href="css/style.css?ver=150325">
	...
	<div id="wrapper">
		...
		<section id="content">
			...
			<!-- <div class="banner">
            	...
            	<div class="fblike hidden-mobile hidden-tablet">
					<iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fpages%2FPOP-DAILY%2F445164788956922&amp;width=40&amp;layout=box_count&amp;action=like&amp;show_faces=true&amp;share=false&amp;height=65" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:55px; height:65px;" allowTransparency="true"></iframe>
					<div class="fb-share-button" data-href="http://popdaily.com.tw/news_detail.php?nid=<?php echo $nid; ?>" data-width="40" data-type="box_count"></div>
				</div>
				...
				<div class="content_sectionL content_sectionL_in" id="content_sectionL">
					...
					<div class="content_block border_topNone">
						...
						<div class="date">
							...
							<span class="fbshare">
								...
								<div class="fb-share-button" data-href="http://popdaily.com.tw/news_detail.php?nid=<?php echo $nid; ?>" data-layout="button"></div>
								<div class="fb-like" data-href="http://popdaily.com.tw/news_detail.php?nid=<?php echo $nid; ?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
						...
						<div class="description">
                            <?php 
															...
															$row_news["news_content"] = preg_replace('#<img (.+) style="(.+)" />#isU', '<img $1 />', $row_news["news_content"]);
                    ...
                    <div class="fb_line mt_15">
						<nobr>
							...
							<div class="fb-like mb_5" data-href="https://www.facebook.com/pages/POP-DAILY/445164788956922" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>	
						</nobr>
					...
					<div class="fb-comments" data-href="http://popdaily.com.tw/news_detail.php?nid=<?php echo $nid;?>" data-width="100%" data-numposts="5" data-colorscheme="light"></div>
