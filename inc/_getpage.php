...
/////////////////*/
	...
	if($page != 1){
		echo  '<li><a href=?'.$querystring.'page='.$pre.' onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('."'imageP'".','."''".','."'images/page_prevover.png'".')"><img src="images/page_prev.png" height="13" width="17" name="imageP" alt=""></a></li>';    
	}
	$viewpage = 6;
	...
	if($page < $page_count){
		echo '<li><a href=?'.$querystring.'page='.($page+1).' onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('."'imageN'".','."''".','."'images/page_nextover.png'".')"><img src="images/page_next.png" height="13" width="17" alt="" name="imageN"></a></li>';
	}
}
