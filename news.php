...
<meta name="copyright" content="<?php echo $copyright; ?>" />
	...
	<link rel="stylesheet" href="css/style.css?ver=150401">
	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<div class="headerR hidden-mobile">
				...
				<span class="hidden-tablet"><a href="#" target="_blank" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('imageinsta','','images/icon_instaover.png')"><img src="images/icon_insta.png" alt="" name="imageinsta"></a></span>
			</div> -->
			...
			<nav class="navigation hidden-mobile">
				...
				?>
					<span <?php echo $i == 8 ? 'class="border_right1"' : ""; ?> >
						<a href="news.php?ntid=<?php echo $row_newt["newsType_id"];?>" <?php echo $row_newt["newsType_id"] == $ntid ? 'class="active"' : ""; ?> >
							<?php echo $row_newt["newsType_Cname"]; ?>
						</a>
					</span>
				<?php
